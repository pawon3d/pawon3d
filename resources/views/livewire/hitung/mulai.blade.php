<div>
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-6">
        <div class="flex flex-col sm:flex-row sm:items-center gap-4 w-full md:w-auto">
            ...
            <h1 class="text-xl font-semibold text-[#666666] text-center sm:text-left">{{ $hitungAction }}</h1>
        </div>
    ...
    <div class="bg-[#fafafa] rounded-[15px] shadow-sm p-6 mb-8">
        <div class="flex flex-col sm:flex-row items-center justify-between gap-5 mb-5">
            <p class="text-base font-medium text-[#666666]">Daftar Persediaan</p>
            <flux:button variant="primary" type="button" wire:click="markAllAs" class="w-full sm:w-auto">
                Tandai
    ...
    <div class="flex flex-col sm:flex-row justify-end gap-4">
        <flux:button variant="filled" icon="x-mark" href="{{ route('hitung.rincian', $hitung_id) }}" wire:navigate class="w-full sm:w-auto">
            Batal
        </flux:button>
        <flux:button variant="secondary" icon="save" type="button" wire:click="save"
            class="px-6 py-2.5 bg-[#3F4E4F] rounded-[15px] shadow-sm flex items-center justify-center gap-2 text-[#F8F4E1] font-semibold w-full sm:w-auto">
            Simpan
        </flux:button>
    </div>
