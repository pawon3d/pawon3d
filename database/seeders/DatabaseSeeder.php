...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        collect($permissionNames)->each(function (string $permission) {
            Permission::firstOrCreate(['name' => $permission]);
        });

        $rolesWithPermissions = [
            'Manajemen Sistem' => $permissionNames,
        ...
        $roles = collect($rolesWithPermissions)->map(function (array $permissions, string $roleName) {
