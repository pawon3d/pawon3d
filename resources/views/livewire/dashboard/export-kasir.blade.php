<div class="space-y-5">
    ...
    <div class="flex items-center gap-[15px]">
        <flux:button variant="primary" icon="arrow-left" href="{{ route('laporan-kasir') }}">
            Kembali
        </flux:button>
        ...
        <div class="flex flex-col gap-[30px] pb-[50px]">
            ...
            <div class="flex flex-col gap-[15px] w-[500px]">
                ...
                <flux:select wire:model.live="reportContent"
                    ...
                    <option value="">Pilih Isi Laporan Kasir</option>
                    <option value="ringkasan">Ringkasan Transaksi</option>
            ...
            <div class="flex flex-col gap-[15px] w-[500px]">
                ...
                <flux:select wire:model.live="saleMethod"
                    class="!bg-[#fafafa] !border-[#adadad] !rounded-[15px] !px-[20px] !py-[10px]">
    ...
    <div class="flex gap-[10px] justify-end">
        <flux:button
            onclick="window.open('{{ route('laporan-kasir.pdf') }}?selectedDate={{ $selectedDate }}&selectedWorker={{ $selectedWorker }}&saleMethod={{ $saleMethod }}', '_blank')"
        ...
        <flux:button
            onclick="window.open('{{ route('laporan-kasir.excel') }}?selectedDate={{ $selectedDate }}&selectedWorker={{ $selectedWorker }}&saleMethod={{ $saleMethod }}', '_blank')"
