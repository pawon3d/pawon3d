    ...
    @else
        ...
        <div class="bg-[#fafafa] rounded-[15px] shadow-[0px_2px_3px_0px_rgba(0,0,0,0.1)] px-5 sm:px-[30px] py-[15px]">
            <div class="flex items-start justify-between">
                <div class="flex flex-col gap-[15px]">
                    ...
                    <h3 class="text-2xl font-bold text-[#333333]">{{ number_format($totalProduction, 0, ',', '.') }}
                        pcs
                    </h3>
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div
                ...
                <div class="flex items-start justify-between">
                    <div class="flex flex-col gap-[15px]">
                        ...
                        <h3 class="text-2xl font-bold text-[#333333]">
                            {{ number_format($successProduction, 0, ',', '.') }}
                            pcs</h3>
                    </div>
                ...
                <div class="flex gap-[10px] text-base text-[#333333]/70 mt-[15px]">
                    <span
                        class="{{ $diffStats['successProduction']['diff'] >= 0 ? 'text-green-600' : 'text-red-600' }}">
            ...
            <div
                ...
                <div class="flex items-start justify-between">
                    <div class="flex flex-col gap-[15px]">
                        ...
                        <h3 class="text-2xl font-bold text-[#333333]">
                            {{ number_format($failedProduction, 0, ',', '.') }}
                            pcs</h3>
                    </div>
                    <div class="relative flex items-center justify-center size-[60px] rounded-[20px]">
                        {{-- Cake Icon --}}
                ...
                <div class="flex gap-[10px] text-base text-[#333333]/70 mt-[15px]">
                    <span
                        class="{{ $diffStats['failedProduction']['diff'] <= 0 ? 'text-green-600' : 'text-red-600' }}">
