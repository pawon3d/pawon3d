        ...
        <div class="bg-[#fafafa] rounded-[15px] shadow-[0px_2px_3px_0px_rgba(0,0,0,0.1)] px-[30px] py-[15px]">
            <div class="flex items-start justify-between">
                <div class="flex flex-col gap-[15px]">
                    ...
                    <h3 class="text-2xl font-bold text-[#333333]">{{ number_format($sessionCount, 0, ',', '.') }}</h3>
                </div>
    ...
    <div class="bg-[#fafafa] rounded-[15px] shadow-[0px_2px_3px_0px_rgba(0,0,0,0.1)] px-[30px] py-[15px]">
        <div class="flex items-start justify-between">
            <div class="flex flex-col gap-[15px]">
                ...
                <h3 class="text-2xl font-bold text-[#333333]">{{ number_format($transactionCount, 0, ',', '.') }}</h3>
            </div>
            <div class="flex items-center justify-center size-[60px] rounded-[20px]">
                <svg class="size-[38px] text-[#74512D]" viewBox="0 0 24 24" fill="currentColor">
                    <path
            ...
            <div class="bg-[#fafafa] rounded-[15px] shadow-[0px_2px_3px_0px_rgba(0,0,0,0.1)] px-[30px] py-[15px]">
                <div class="flex items-start justify-between">
                    <div class="flex flex-col gap-[10px]">
                        ...
                        <h3 class="text-2xl font-bold text-[#333333]">{{ number_format($productSold, 0, ',', '.') }}
                            pcs</h3>
                    </div>
                    <div class="flex items-center justify-center size-[60px] rounded-[20px]">
                        <svg class="size-[38px] text-[#74512D]" viewBox="0 0 24 24" fill="currentColor">
                ...
                <div class="flex gap-[10px] text-base text-[#333333]/70 mt-[10px]">
                    <span class="{{ $diffStats['productSold']['diff'] >= 0 ? 'text-green-600' : 'text-red-600' }}">
        ...
        <x-table.paginated :headers="$productSalesHeaders" :paginator="$productSalesPaginator" emptyMessage="Tidak ada data penjualan"
            ...
            @foreach ($productSalesPaginator as $item)
                <tr class="border-b border-[#e5e5e5] hover:bg-gray-50">
                    ...
                    <td class="py-3 px-4 text-center text-[#333333]">{{ number_format($item->produksi, 0, ',', '.') }}
                    </td>
                    <td class="py-3 px-4 text-center text-[#333333]">{{ number_format($item->sold, 0, ',', '.') }}
                    </td>
                    <td class="py-3 px-4 text-center text-[#333333]">{{ number_format($item->unsold, 0, ',', '.') }}
                    </td>
                </tr>
            @endforeach
        </x-table.paginated>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div class="flex flex-col gap-5">
            ...
            <div class="bg-[#fafafa] rounded-[15px] shadow-[0px_2px_3px_0px_rgba(0,0,0,0.1)] px-[30px] py-[15px]">
                ...
                <div class="flex gap-[10px] text-base text-[#333333]/70 mt-[10px]">
                    <span class="{{ $diffStats['grossRevenue']['diff'] >= 0 ? 'text-green-600' : 'text-red-600' }}">
        ...
        <div class="bg-[#fafafa] rounded-[15px] shadow-[0px_2px_3px_0px_rgba(0,0,0,0.1)] px-[30px] py-[15px]">
            <div class="flex items-start justify-between">
                <div class="flex flex-col gap-[10px]">
                    ...
                    <h3 class="text-2xl font-bold text-[#333333]">Rp {{ number_format($netRevenue, 0, ',', '.') }}
                    </h3>
                </div>
                <div class="flex items-center justify-center size-[60px] rounded-[20px]">
                    <svg class="size-[38px] text-[#74512D]" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div class="bg-[#fafafa] rounded-[15px] shadow-[0px_2px_3px_0px_rgba(0,0,0,0.1)] px-[30px] py-[15px]">
            <div class="flex items-start justify-between">
                <div class="flex flex-col gap-[10px]">
                    ...
                    <h3 class="text-2xl font-bold text-[#333333]">Rp {{ number_format($profit, 0, ',', '.') }}</h3>
                </div>
                <div class="flex items-center justify-center size-[60px] rounded-[20px]">
                    <svg class="size-[38px] text-[#74512D]" viewBox="0 0 24 24" fill="currentColor">
