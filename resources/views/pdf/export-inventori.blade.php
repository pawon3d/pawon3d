        ...
        <div class="expense-box">
            ...
            <div class="expense-header">
                <div class="expense-info">
                    ...
                    <span class="badge {{ $expense['status'] === 'Lunas' ? 'badge-success' : 'badge-warning' }}">
                        {{ $expense['status'] }}
                    </span>
                </div>
                <div class="expense-info">
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right">{{ number_format($material['quantity_used'], 2, ',', '.') }}{{
                        !empty($material['unit_alias']) ? ' '.$material['unit_alias'] : '' }}</td>
