                    ...
                    <tr>
                        ...
                        <td class="px-6 py-3">
                            <input type="number" placeholder="0"
                                wire:model.number.live="expenseDetails.{{ $index }}.quantity" class="w-full border-0 border-b 
                            ...
                            <span class="text-xs text-red-500">Nilai melebihi jumlah yang diharapkan</span>
                            @endif
