...
<body class="antialiased">
    <div class="relative grid grid-cols-1 md:grid-cols-2 items-top justify-center min-h-screen sm:items-center sm:pt-0">
        ...
        <div class="wrapper">
            <h2 class="text-4xl font-light">Hmm...</h2>
