    ...
    <div class="bg-[#fafafa] rounded-[15px] shadow-sm p-4 sm:px-[30px] sm:py-6">
        ...
        <div class="flex flex-col lg:flex-row items-center justify-between mb-8 gap-4">
            <div class="flex flex-col sm:flex-row items-center gap-4 w-full">
                <!-- Search Bar -->
                <div
                    class="w-full lg:w-[450px] flex items-center border border-[#666666] rounded-[20px] bg-white px-4 py-2">
        ...
        <div class="overflow-x-auto">
            <div class="min-w-[1000px]">
                <x-table.paginated :headers="$headers" :paginator="$productions" :empty-message="'Belum ada produksi.'"
                    ...
                    <tr class="border-b border-[#d4d4d4] hover:bg-gray-50" wire:key="production-{{ $production->id }}">
                        ...
                        <td class="px-6 py-5 w-[185px]">
                            <div class="flex flex-col gap-1">
                                <div class="flex items-center gap-2 text-[14px] font-medium text-[#666666]">
                                    ...
                                    <span>{{ $production->created_at ? $production->created_at->format('H:i') : ''
                                        }}</span>
                                </div>
                                ...
                                @endphp
                                <span class="text-[14px] font-medium text-[#666666]">(H-{{ abs($daysFromProduction)
                                    }})</span>
                                @endif
                            </div>
                        </td>
                        ...
                        <td class="px-6 py-5 w-[185px]">
                            <div class="flex flex-col gap-1">
                                ...
                                @endphp
                                <span class="text-[14px] font-medium text-[#eb5757]">(H-{{ abs($daysUntil) }})</span>
                                @endif
                            </div>
                        </td>
                        @endif
                        ...
                        <td class="px-6 py-5 w-[200px]">
                            ...
                            <div class="flex flex-col gap-1.5">
                                ...
                                <p class="text-[12px] font-medium text-[#525252] text-center">
                                    {{ number_format($progress, 0) }}% (<span class="text-[#525252]">{{ $total_done
                                        }}</span> <span class="font-normal">dari</span> <span class="text-[#525252]">{{
                                        $total_plan }}</span>)
                                </p>
                            </div>
                        </td>
