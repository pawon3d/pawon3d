<div class="space-y-8">
    <header class="flex flex-wrap items-center justify-between gap-4">
        <div class="flex items-center gap-4">
            ...
            <h1 class="text-xl font-semibold text-[#666666]">Tambah Produk</h1>
        </div>
    </header>

    {{-- Info Penting Banner --}}
    <x-alert.info>
        Tambah Produk. Lengkapi informasi yang diminta, pastikan informasi yang dimasukan benar dan tepat. Informasi
        akan ditampilkan untuk dipilih dalam proses produksi, penyiapan inventori, dan panjualan oleh kasir.
    </x-alert.info>
                        ...
                        <div class="flex items-center justify-between border-b border-dashed border-slate-200 pb-4">
                            ...
                            @if ($is_other)
                                <div class="flex justify-end gap-4">
                                    ...
                                    <flux:button type="button" wire:click="addOther" variant="primary"
                                        icon="plus">
                                ...
                                <tbody class="bg-white text-[#666666]">
                                    @foreach ($other_costs as $index => $other)
                                        <tr class="border-b border-[#D4D4D4]">
                                            ...
                                            <td class="px-6 py-4 text-center">
                                                <button type="button" wire:click="removeOther({{ $index }})"
                                                    class="text-[#666666] hover:text-red-600">
                                                    <svg class="h-5 w-5" fill="none" stroke="currentColor"
                                                        viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <div class="space-y-4">
        ...
        <div class="overflow-hidden rounded-[15px] border border-[#FAFAFA]">
            <table class="w-full text-sm">
                ...
                <tbody class="bg-white text-[#666666]">
                    <tr class="border-b border-[#D4D4D4]">
                        <td class="px-6 py-4 font-medium">Suhu Ruangan <span class="font-normal">(20–25°C)</span></td>
                        <td class="px-6 py-4">
                    ...
                    <tr class="border-b border-[#D4D4D4]">
                        <td class="px-6 py-4 font-medium">Suhu Dingin <span class="font-normal">(4–8°C)</span></td>
                        <td class="px-6 py-4">
...
<div class="mt-6 space-y-6">
    ...
    <div class="rounded-[15px] border border-[#FAFAFA] bg-white p-6">
        <div class="flex items-center justify-between">
            ...
            @if ($soloInventory)
                <span class="rounded-full bg-indigo-50 px-4 py-1 text-sm font-semibold text-indigo-600">
...
<section class="flex flex-wrap gap-20 overflow-hidden rounded-[15px] border border-[#FAFAFA] bg-white p-8 shadow-sm">
    {{-- Modal dan Harga --}}
    <div class="flex-1 space-y-4">
        ...
        <div class="space-y-2.5">
            <div class="flex items-center justify-between">
                <span class="text-sm font-medium text-[#666666]">{{ $pcs > 1 ? 'Modal/Resep' : 'Modal' }}</span>
                <span class="text-base font-medium text-[#666666]">Rp{{ number_format($capital, 0, ',', '.') }}</span>
            </div>
            @if ($pcs > 1)
                <div class="flex items-center justify-between">
...
<section class="flex flex-wrap gap-8 overflow-hidden rounded-[15px] border border-[#FAFAFA] bg-white p-8 shadow-sm">
    <div class="flex-1 space-y-4">
...
<div class="flex justify-end gap-2.5">
    ...
    <button type="button" wire:click="store" wire:loading.attr="disabled"
        ...
        Simpan
        <div wire:loading wire:target="store" class="animate-spin">
