    ...
    <div class="w-full mt-8 ml-3">
        ...
        <div class="w-full flex md:flex-row flex-col gap-8 mt-2">
            ...
            <div class="md:w-1/2 flex flex-col gap-4 mt-4">
                ...
                <flux:input placeholder="Contoh: Kue Rumahan Lezat, Sehangat Pelukan Ibu" wire:model.defer="tagline" />
                    ...
                    <thead class="bg-gray-100 text-gray-700">
                        <tr>
                            ...
                            <th class="px-6 py-3 font-semibold cursor-pointer" wire:click='sortBy("valid_from")'>
                                Tanggal Terbit
                                <span>{{ $sortDirection === 'asc' && $sortField === 'valid_from' ? '↑' : '↓' }}</span>
                            </th>
                            <th class="px-6 py-3 font-semibold cursor-pointer" wire:click='sortBy("valid_until")'>
                                Berlaku Hingga
                                <span>{{ $sortDirection === 'asc' && $sortField === 'valid_until' ? '↑' : '↓' }}</span>
                            </th>
                        </tr>
                    </thead>
