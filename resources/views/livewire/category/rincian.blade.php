<div>
    <div class="mb-4 flex items-center justify-between">
        <div class="flex items-center">
            ...
            <h1 class="text-2xl hidden md:block">Rincian Kategori Produk</h1>
        </div>
    ...
    <div class="w-full flex md:flex-row flex-col gap-8 mt-4">
        <div class="md:w-1/2 flex flex-col gap-4 mt-4">
            ...
            <p class="text-sm text-gray-500">Masukkan nama kategori produk sesuai ciri khas profuk yang dijual, seperti
                "Kue
        ...
        <div class="md:w-1/2 flex flex-col gap-4 mt-4">
            ...
            <p class="text-sm text-gray-500">Jumlah produk yang berada di dalam kategori yang sama.</p>
