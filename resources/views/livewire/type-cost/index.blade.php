<div>
    ...
    <div class="bg-[#fafafa] rounded-[15px] shadow-sm px-8 py-6">
        ...
        <div class="rounded-[15px] overflow-hidden border border-[#d4d4d4]">
            ...
            <div
                ...
                <div class="flex-1 min-w-[100px] px-6 py-5 flex items-center justify-end gap-1.5 cursor-pointer"
                    wire:click="sortBy('other_costs_count')">
        ...
        <div class="flex justify-between items-center mt-5">
            <p class="text-sm font-medium text-[#666666] opacity-70">
                Menampilkan {{ $typeCosts->firstItem() ?? 0 }} hingga {{ $typeCosts->lastItem() ?? 0 }} dari
                {{ $typeCosts->total() }} baris data
            </p>
            <div class="flex items-center gap-2.5">
                ...
                <div class="min-w-[30px] px-2.5 py-1.5 bg-[#666666] rounded-md text-center">
                    <span class="text-sm font-medium text-[#fafafa]">{{ $typeCosts->currentPage() }}</span>
                </div>
    ...
    <flux:modal name="tambah-jenis" class="w-full max-w-[560px]" wire:model="showModal">
        <div class="bg-[#fafafa] rounded-[15px] px-8 py-9 space-y-12">
            <div class="space-y-8">
                ...
                <div class="space-y-5">
                    ...
                    <div class="space-y-2.5">
                        <label for="name" class="block text-base font-medium text-[#666666]">Jenis Biaya</label>
            ...
            <div class="flex justify-end gap-2.5">
                ...
                <button type="button" wire:click="store"
                    class="bg-[#3f4e4f] hover:bg-[#2f3e3f] text-[#f8f4e1] font-semibold text-base px-6 py-2.5 rounded-[15px] shadow-sm flex items-center gap-2 transition-colors cursor-pointer">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                        <path
    ...
    <!-- Modal Rincian Jenis Biaya -->
    <flux:modal name="rincian-jenis" class="w-full max-w-[560px]" wire:model="showEditModal">
        <div class="bg-[#fafafa] rounded-[15px] px-8 py-9 space-y-12">
            <div class="space-y-8">
                ...
                <div class="space-y-10">
                    <div class="space-y-5">
                        <!-- Jenis Biaya -->
                        <div class="space-y-2.5">
                            <label for="edit_name" class="block text-base font-medium text-[#666666]">Jenis
                                Biaya</label>
                    ...
                    <div class="flex items-center justify-between">
                        <label class="text-base font-medium text-[#666666]">Jumlah Penggunaan</label>
        ...
        <flux:modal name="delete-type-cost" class="w-full max-w-md">
            <div class="bg-white rounded-[15px] p-8">
                <div class="space-y-6">
                    <div>
                        <h2 class="text-xl font-medium text-[#333333]">Hapus Jenis Biaya</h2>
    ...
    <flux:modal name="usage-modal" class="w-full max-w-[700px]" wire:model="showUsageModal">
        <div class="bg-[#fafafa] rounded-[15px] shadow-sm px-8 py-6 space-y-8">
            <div class="space-y-5">
                <h3 class="text-lg font-medium text-[#333333]">Daftar Produk</h3>
                ...
                <div class="flex items-center bg-white border border-[#666666] rounded-full px-4 py-0">
                    ...
                    <input wire:model.live="usageSearch" placeholder="Cari Produk"
                        class="flex-1 px-2.5 py-2.5 focus:outline-none text-[#959595] text-base font-medium border-none" />
                </div>
                ...
                <div class="space-y-5">
                    <div class="rounded-[15px] overflow-hidden">
                        ...
                        <div class="bg-[#3f4e4f] flex items-center">
                            <div class="flex-1 min-w-[270px] px-6 py-5 flex items-center gap-1.5">
                                <span class="font-bold text-sm text-[#f8f4e1]">Produk</span>
                    ...
                    <div class="flex justify-between items-center">
                        <p class="text-sm font-medium text-[#666666] opacity-70">
                            Menampilkan 1 hingga {{ $usageProducts ? $usageProducts->count() : 0 }} dari
                            {{ $usageProducts ? $usageProducts->count() : 0 }} baris data
                        </p>
                        <div class="flex items-center gap-2.5">
                            <button disabled
                                class="min-w-[30px] px-2.5 py-1.5 bg-[#fafafa] border border-[#666666] rounded-md opacity-50 cursor-not-allowed">
    ...
    <flux:modal name="riwayat-pembaruan" class="w-full max-w-2xl" wire:model="showHistoryModal">
        <div class="space-y-6">
            <div>
                <flux:heading size="lg">Riwayat Pembaruan Jenis Biaya Produksi</flux:heading>
            </div>
