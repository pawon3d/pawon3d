...
class MulaiSiapBeli extends Component
{
    ...
    public function mount($id)
    {
        ...
        View::share('title', 'Dapatkan Hasil Produksi Siap Beli');
    ...
    public function save()
    {
        ...
        return redirect()->route('produksi.rincian-siap-beli', ['id' => $this->production_id])
    ...
    {
        return view('livewire.production.mulai-siap-beli');
    }
}
