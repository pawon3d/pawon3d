...
<body class="bg-[#FDFDFC] text-[#1b1b18] montserrat-regular">
    ...
    <header class="sticky top-0 bg-[#74512d] z-50 shadow-sm">
        <nav class="max-w-[1280px] mx-auto px-[50px] py-0 h-[100px] flex items-center justify-between">
            ...
            <div class="flex items-center gap-[40px]">
                <a class="w-[64px] h-[64px]" href="/" wire:navigate>
    ...
    <footer class="bg-[#252324] text-white">
        <div class="max-w-[1280px] mx-auto px-[80px] py-[44px]">
            <!-- Top Section: Logo, Ikuti Kami, Halal -->
            <div class="flex items-center justify-between pb-[40px] mb-[40px] border-b border-white">
                <!-- Logo -->
                ...
                <div class="flex items-center gap-[15px]">
                    <a href="https://www.instagram.com/pawon3d/" target="_blank"
                        class="flex items-center justify-center gap-4 hover:opacity-80 transition-all">
                        <span class="text-[20px] montserrat-bold text-white">Ikuti Kami</span>
                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                            <path
            ...
            <!-- Footer Content Grid -->
            <div class="grid grid-cols-4 gap-8 mb-[60px]">
                <!-- Kontak Kami & Alamat -->
                <div class="flex flex-col gap-[40px]">
                    <!-- Kontak Kami -->
                    <div>
                        <h3 class="text-[20px] montserrat-bold mb-[15px]">Kontak Kami</h3>
                        <div class="flex flex-col gap-[15px]">
                            <a href="tel:{{ $storeProfile->contact ?? '081234567891' }}"
                                class="flex items-center gap-[10px] text-[#c4c4c4] montserrat-regular text-[18px] hover:text-white transition-colors">
                    ...
                    <!-- Alamat dan Lokasi -->
                    <div>
                        <h3 class="text-[20px] montserrat-bold mb-[10px]">Alamat dan Lokasi</h3>
                        <div class="flex flex-col gap-[10px]">
                            <p class="text-[#c4c4c4] montserrat-regular text-[18px]">
                ...
                <!-- Jelajahi -->
                <div>
                    <h3 class="text-[20px] montserrat-bold mb-[15px]">Jelajahi</h3>
                ...
                <!-- Informasi -->
                <div>
                    <h3 class="text-[20px] montserrat-bold mb-[15px]">Informasi</h3>
                    <ul class="flex flex-col gap-[15px]">
                        <li><a href="/#tentang"
                ...
                <!-- Bantuan -->
                <div>
                    <h3 class="text-[20px] montserrat-bold mb-[15px]">Bantuan</h3>
                    <ul class="flex flex-col gap-[15px]">
