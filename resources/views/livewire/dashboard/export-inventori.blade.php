<div class="space-y-5">
    ...
    <div class="flex items-center gap-[15px]">
        <flux:button variant="primary" icon="arrow-left" href="{{ route('laporan-inventori') }}">
            Kembali
        </flux:button>
        ...
        <div class="flex flex-col gap-[30px] pb-[50px]">
            ...
            <div class="flex flex-col gap-[15px] w-[500px]">
                ...
                <flux:select wire:model.live="reportContent"
                    ...
                    <option value="produksi">Penggunaan Produksi</option>
    ...
    <div class="flex gap-[10px] justify-end">
        <flux:button
            onclick="window.open('{{ route('laporan-inventori.pdf') }}?selectedDate={{ $selectedDate }}&selectedWorker={{ $selectedWorker }}', '_blank')"
        ...
        <flux:button
            onclick="window.open('{{ route('laporan-inventori.excel') }}?selectedDate={{ $selectedDate }}&selectedWorker={{ $selectedWorker }}', '_blank')"
