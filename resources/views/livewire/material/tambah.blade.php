<div>
    ...
    @if ($material_details[0]['unit_id'] != null && $material_details[0]['unit_id'] != '')
        ...
        <div class="w-full flex flex-col gap-4 mt-8">
            ...
            <p class="text-sm text-gray-500">
                Belanja barang persediaan untuk mendapatkan jumlah persediaan dan tanggal expired (merah expired, kuning
        ...
        <div>
            <div class="w-full mt-8 flex flex-col gap-4">
                ...
                <p class="text-sm text-gray-500">
                    Masukkan nilai minimum persediaan untuk pembaruan status persediaan. Status terdiri dari Tersedia
                    (lebih
