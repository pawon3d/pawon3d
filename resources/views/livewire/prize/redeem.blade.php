...
new class extends Component {
    ...
    {
        View::share('title', 'Kode Hadiah Yang Sudah Ditukar');
    }

    public function with() : array {
        return [
            'prizes' => \App\Models\Prize::where('is_redeem', true)->when($this->search_code, function ($query) {
...
<section class="w-full">
    <x-prize.layout :heading="__('Kode Hadiah Yang Sudah Ditukar')">
