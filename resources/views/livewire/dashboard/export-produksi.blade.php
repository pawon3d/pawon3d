<div class="space-y-5">
    ...
    <div class="flex items-center gap-[15px]">
        <flux:button variant="secondary" icon="arrow-left" href="{{ route('laporan-produksi') }}" wire:navigate>
            Kembali
        </flux:button>
        ...
        <div class="flex flex-col gap-[30px] pb-[50px]">
            ...
            <div class="flex flex-col gap-[15px] w-[500px]">
                ...
                <flux:select wire:model.live="reportContent"
                    ...
                    <option value="berhasil">Produksi Berhasil</option>
                    <option value="gagal">Produksi Gagal</option>
                </flux:select>
            </div>
            ...
            <div class="flex flex-col gap-[15px] w-[500px]">
                <label class="text-[#666666] text-[16px] font-medium">
                    Metode Produksi <span class="text-[#eb5757]">*</span>
                </label>
                <flux:select wire:model.live="selectedMethod"
                    class="!bg-[#fafafa] !border-[#adadad] !rounded-[15px] !px-[20px] !py-[10px]">
                    <option value="semua">Semua Metode Produksi</option>
    ...
    <div class="flex gap-[10px] justify-end">
        <flux:button
            onclick="window.open('{{ route('laporan-produksi.pdf') }}?reportContent={{ $reportContent }}&filterPeriod={{ $filterPeriod }}&selectedDate={{ $selectedDate }}&customStartDate={{ $customStartDate }}&customEndDate={{ $customEndDate }}&selectedWorker={{ $selectedWorker }}&selectedMethod={{ $selectedMethod }}', '_blank')"
        ...
        <flux:button
            onclick="window.open('{{ route('laporan-produksi.excel') }}?reportContent={{ $reportContent }}&filterPeriod={{ $filterPeriod }}&selectedDate={{ $selectedDate }}&customStartDate={{ $customStartDate }}&customEndDate={{ $customEndDate }}&selectedWorker={{ $selectedWorker }}&selectedMethod={{ $selectedMethod }}', '_blank')"
