<div>
        ...
        @if ($todayShiftStatus == 'open')
            <div>
                <div class="flex items-center justify-between mt-4 mb-4 flex-row w-full">
                    ...
                    <div class="relative w-full">
                        <input type="radio" name="method" id="pesanan-kotak" value="pesanan-kotak"
                            wire:model.live="method" class="absolute opacity-0 w-0 h-0">
                                                    ...
                                                    @if ($product->reviews->count() > 0)
                                                        <span class="text-yellow-500 flex items-center">
                                                            ...
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                class="h-3 w-3 ml-0.5" viewBox="0 0 20 20"
                                                                fill="currentColor">
                                                                <path
                                                ...
                                                <li class="flex justify-between items-start border-b pb-2">
                                                    ...
                                                    <div class="text-right">
                                                        ...
                                                        <div class="flex items-center mt-2 justify-end gap-1">
                                                            ...
                                                            <div
                                                                class="bg-gray-100 rounded-xl px-4 flex items-center gap-2">
                                                                <button
    ...
    <flux:modal name="close-shift-modal" class="w-full max-w-md" wire:model="closeShiftModal">
        <div class="space-y-6">
            <div class="p-4">
                ...
                <div class="flex items-center justify-between mt-2 mb-2">
                    ...
                    <span
                        class="text-sm text-gray-500">{{ \Carbon\Carbon::parse($todayShiftStartTime)->format('d/m/Y
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        H:i') }}</span>
                </div>
                <div class="flex items-center justify-between mt-2 mb-2">
                ...
                <div class="flex items-center justify-between mt-2 mb-2">
                    <span class="text-sm text-gray-500">Penerimaan Tunai
                ...
                <div class="flex items-center justify-between mt-2 mb-2">
                    <span class="text-sm text-gray-500 flex items-center">Penerimaan Non Tunai
                        <flux:button icon="information-circle" iconVariant="outline" loading="false" variant="ghost"
                            ...
                            wire:click="showNonCashDetails('{{ $todayShiftId }}')" />
                    </span>
                    <span class="text-sm text-gray-500">Rp{{ number_format($receivedNonCash, 0, ',', '.') }}</span>
                </div>
                <div class="flex items-center justify-between mt-2 mb-2">
        ...
        <div class="mt-6 flex justify-end space-x-2">
            ...
            <flux:button type="button" icon="stop" iconVariant="solid" variant="primary"
                wire:click="closeShift">Tutup
            </flux:button>
        </div>
    </flux:modal>
        ...
        <div class="space-y-6">
            <div class="p-4">
                ...
                <div class="flex items-center justify-between mt-2 mb-2">
                    ...
                    <span
                        class="text-sm text-gray-500">{{ \Carbon\Carbon::parse($todayShiftEndTime)->format('d/m/Y
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        H:i') }}</span>
                </div>
                <div class="flex items-center justify-between mt-2 mb-2">
                    <span class="text-sm text-gray-500">Dibuka Oleh</span>
                ...
                <div class="flex items-center justify-between mt-2 mb-2">
                    ...
                    <span
                        class="text-sm text-gray-500">Rp{{ number_format($finalCash - $expectedCash, 0, ',', '.') }}</span>
                </div>
            </div>
        </div>
