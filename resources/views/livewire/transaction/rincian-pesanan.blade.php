                    ...
                    <thead style="background-color: #3f4e4f; color: #f8f4e1;">
                        <tr>
                            <th class="px-6 py-3 text-left"
                                style="padding: 15px 20px; font-weight: 600; font-size: 14px; line-height: 1;">Produk
                            </th>
        ...
        <flux:modal class="w-full max-w-4xl" name="riwayat" wire:model="riwayatModal">
            <div class="space-y-6">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-2">Berikut adalah riwayat perubahan yang terjadi pada pesanan
                        ini
                    </p>
                </div>
