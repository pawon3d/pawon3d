<div>
    ...
    <div
        class="w-full flex items-start text-start space-x-2 gap-3 flex-col mt-8 mb-2 bg-white border-gray-300 rounded-lg p-4">
                    ...
                    <div class="flex flex-col text-sm text-gray-600 gap-1">
                        <div class="flex items-center gap-2">
                            ...
                            <div class="flex flex-row text-xs ml-2 gap-3 items-center">
                                ...
                                <flux:button icon="arrow-down-tray" iconVariant="micro" variant="primary"
                                    class="order-3" wire:click="downloadImage('{{ $payment->id }}')" />
                                <flux:button icon="eye" iconVariant="micro" variant="primary" class="order-2"
                                    wire:click="showImageModal('{{ $payment->id }}')" />
                                <flux:button icon="arrow-up-tray" iconVariant="micro" variant="primary" class="order-4"
                        ...
                        @if ($payment->id == $pembayaranKedua->id && $payment->payment_method == 'tunai' && $kembalian >
                        0)
                        <div class="flex flex-col text-sm text-gray-600 gap-1 mt-1">
    ...
    <div class="flex justify-end mt-16 gap-4">
        ...
        <flux:button icon="receipt-refund" iconVariant="solid" type="button" class="cursor-pointer"
            ...
            <div class="relative min-h-screen pb-32">
                ...
                <div class="max-w-sm mt-8 mb-4 mx-auto border-gray-300 bg-white text-sm rounded-lg shadow-md p-4 font-sans fade-slide-up"
                    ...
                    <div class="text-center mb-4">
                        <h1 class="text-2xl font-bold pacifico-regular">Pawon3D</h1>
    ...
    <flux:modal class="w-full max-w-md" name="refund" wire:model="refundModal">
        <div class="space-y-6">
            <div>
                <flux:heading size="lg">Refund Pesanan</flux:heading>
            </div>
            <div>
                <ul class="space-y-3">
                    ...
                    <li class="flex justify-between items-start border-b pb-2">
                        <div class="text-left">
                            ...
                            <div class="flex items-center justify-start mt-2">
                                <p class="text-sm text-gray-500 py-1">{{ $item['refund_quantity'] }} x
                        ...
                        <div class="text-right">
                            <div class="flex items-center justify-end mt-1">
                                <p class="text-sm text-right text-gray-500">
                                    Rp{{ number_format($item['price'] * $item['refund_quantity'], 0, ',', '.') }}
                                </p>
                            </div>
                ...
                <div class="flex flex-row justify-between items-center mt-3">
                    <p class="text-sm font-semibold">Total Refund</p>
                    <p class="text-sm font-semibold">Rp{{ number_format($refundTotal, 0, ',', '.') }}</p>
                </div>
            </div>
            <div class="mt-6 flex justify-end space-x-2">
                <flux:modal.close>
                ...
                <flux:button type="button" icon="receipt-refund" variant="primary" wire:click="refundStore">Refund
                </flux:button>
            </div>
        </div>
    </flux:modal>
