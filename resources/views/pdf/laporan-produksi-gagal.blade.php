...
<head>
    ...
    <title>Laporan Produksi Gagal</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th width="15%" class="text-center">Gagal</th>
    ...
    @else
        <div class="empty-message">
            Tidak ada data produksi gagal untuk periode dan filter yang dipilih.
        </div>
    @endif
