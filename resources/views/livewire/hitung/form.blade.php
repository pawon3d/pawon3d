<div>
    ...
    <div class="bg-[#fafafa] rounded-[15px] shadow-sm p-6">
        ...
        <div class="space-y-4 mb-4">
            ...
            <div class="flex justify-between items-start gap-4">
                ...
                <flux:button variant="primary" wire:click="addDetail" icon="plus">
                    Tambah Barang
                </flux:button>
            </div>
        </div>
        ...
        {{-- Table --}}
        <div class="overflow-x-auto rounded-t-[15px]">
            <table class="w-full">
                <thead>
                    <tr class="bg-[#3F4E4F] text-[#F8F4E1]">
                        <th class="px-6 py-4 text-left text-sm font-bold w-[255px]">Barang Persediaan</th>
                        <th class="px-6 py-4 text-left text-sm font-bold w-[250px]">Batch</th>
                        <th class="px-6 py-4 text-right text-sm font-bold">Jumlah Terkini</th>
                        <th class="px-6 py-4 text-right text-sm font-bold">Modal</th>
    ...
    <div class="flex justify-end gap-3 mt-8">
        ...
        <flux:button variant="primary" wire:click="save" icon="{{ $this->isEditMode() ? 'check' : 'archive-box' }}">
