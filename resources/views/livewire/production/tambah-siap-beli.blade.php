<div style="background: #eaeaea; padding: 30px;">
    ...
    <div class="flex flex-col gap-[30px]">
        ...
        <div class="flex items-center gap-[30px] justify-end">
            <button wire:click="$navigate('{{ route('produksi.antrian-produksi') }}')"
                class="bg-[#c4c4c4] rounded-[15px] shadow-[0px_2px_3px_0px_rgba(0,0,0,0.1)] px-[25px] py-[10px] flex items-center gap-2">
                <svg class="w-[20px] h-[20px] text-[#333333]" fill="currentColor" viewBox="0 0 24 24">
                    <path
            ...
            <button wire:click="store"
                ...
                <svg class="w-[16px] h-[16px] text-white" fill="currentColor" viewBox="0 0 24 24">
                    <path
